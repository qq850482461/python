...
class RegisterForm(FlaskForm):
    ...
    password = PasswordField(label='密码',validators=[DataRequired(),Length(6,15,message='密码长度在6到15位')])
    password2 = PasswordField(label='确认密码', validators=[DataRequired(),EqualTo('password',message='密码必须一致')])
